...
def notification():
    if request.method == 'POST':
        ...
        try:
            ...
            with ServiceBusClient.from_connection_string(app.config.get('SERVICE_BUS_CONNECTION_STRING'), logging_enable=True) as client:
                with client.get_queue_sender(app.config.get('SERVICE_BUS_QUEUE_NAME')) as sender:
